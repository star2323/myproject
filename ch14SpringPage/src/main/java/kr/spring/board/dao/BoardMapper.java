...
public interface BoardMapper {
	...
	@Insert("INSERT INTO spboard (num,title,content,reg_date,"
			+ "uploadfile,filename,ip,id) VALUES ("
			+ "board_seq.nextval,#{title},#{content},"
			+ "SYSDATE,#{uploadfile},#{filename},#{ip},#{id})")
